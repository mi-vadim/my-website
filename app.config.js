...
export default {
  ...
  technologies: {
    ...
    meta: [
      ...
      { name: 'ClickHouse', image: '/images/ch.png' },
      { name: 'PostgreSQL', image: '/images/pgsql.png' },
  ...
  strings: {
    en_US: {
      ...
      hero: {
        ...
        words: ['developer', 'backender', 'engineer', 'programmer'],
      },
      githubCalendar: {
    ...
    ru_RU: {
      ...
      hero: {
        iBlogTech: 'мой блог',
        haveALook: 'почитайте!',
        friendlyNeighborhood: 'ваш дружелюбный сосед',
        description: 'i am a software engineer and a part time freelancer. i blog tech, write a weekend newsletter called software shots, and tinker with side projects every now n then.',
        words: ['разработчик', 'бекендер', 'инженер', 'программер'],
      },
      githubCalendar: {
        header: 'опенсорсная деятельность',
        subtext: 'github calendar heatmap'
      },
      blog: {
        header: 'блог',
        subtext: 'стараюсь писать о всем том, что мне интересно и как-то прокачивает скилл'
      },
      recentBlog: {
      ...
      projects: {
        header: 'проекты',
        subtext: 'тут список проектов над которыми я трудился. у каждого своя предыстория, поэтому не стесняемся, нажимаем и читаем :)'
      },
      recommendations: {
        header: 'рекомендации',
        subtext: 'что обо мне люди говорят'
      },
      technologies: {
        header: 'технологии',
        subtext: 'то во что я умею и могу'
      }
    },
  }
}
